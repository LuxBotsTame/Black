...
if Dev(msg) then
if text == "تحديث" or text == "تحديث الصانع 🔁" then
...
data = {
{
{text = 'صنع بوت ➕',type = 'text'},{text = 'حذف البوت ✖️',type = 'text'},
},
{
...
{
{text = 'عدد البوتات 📊',type = 'text'},{text = 'فحص ♻️',type = 'text'},
},
{
...
if text == "الغاء" or text == 'إلغاء 🚫' then   
...
send(msg.chat_id,msg.id,"⌔︰اهلأ بك ( '..UserInfousername..' ) .\n⌔︰في مصنع سورس بلاك الجديد .\n⌔︰مجاني و سريع مدة الحياة .\n⌔︰مقدم من قناة : @QQ2_Q","html",true, false, false, true, reply_markup)
return false 
end
---making user
